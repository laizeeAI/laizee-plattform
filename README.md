...
> - Erstellen Sie ein Projekt unter dem Button *Erstellen* mit einem beliebigen Namen und dem *Projektyp* *Textklassifikation*. Sie müssen außerdem eine kurze *Beschreibung* hinzufügen.
######      1.2 Tagging 
...
>- Für das Hochladen klicken Sie unter dem Tab *Datensatz* auf *Regeln*. Dort können Sie über *Aktionen* *Regeln uploaden*. In dem dann auftauchenden Feld können können Sie unter *Wähle eine Option* *Regeln für ein Label* auswählen und das Label *Location* benutzen.
