package de.fhaachen.handler;

import de.fhaachen.handler.auth.ApiKeyAuth;
import de.fhaachen.handler.auth.Authentication;
import de.fhaachen.handler.auth.HttpBasicAuth;
import de.fhaachen.handler.auth.OAuth;
